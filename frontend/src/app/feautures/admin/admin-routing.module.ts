...
const routes: Routes = [
  {
    ...
    data: { title: marker('Upload file') },
    canActivate: [AdminGuard],
  },
  { path: 'link-file', component: LinkFileComponent, data: { title: marker('Link file') }, canActivate: [AdminGuard] },
  {
    path: 'register-product',
    component: RegisterProductComponent,
    data: { title: marker('Register Product') },
    canActivate: [AdminGuard],
  },
  {
    path: 'list-product',
    component: ListProductComponent,
    data: { title: marker('List Product') },
    canActivate: [AdminGuard],
  },
  {
    path: 'register-product-model',
    component: RegisterProductModelComponent,
    data: { title: marker('Register Product Model') },
    canActivate: [AdminGuard],
  },
  {
    path: 'list-product-model',
    component: ListProductModelComponent,
    data: { title: marker('List Product Model') },
    canActivate: [AdminGuard],
  },
  {
    path: 'register-user',
    component: RegisterUserComponent,
    data: { title: marker('Register User') },
    canActivate: [AdminGuard],
  },
  {
    path: 'list-user',
    component: ListUsersComponent,
    data: { title: marker('List User') },
    canActivate: [AdminGuard],
  },
  {
    path: 'register-department',
    component: RegisterDepartmentComponent,
    data: { title: marker('Register Department') },
    canActivate: [AdminGuard],
  },
  {
    path: 'list-department',
    component: ListDepartmentsComponent,
    data: { title: marker('List Department') },
    canActivate: [AdminGuard],
  },
  {
    path: 'signature',
    component: SignatureComponent,
    data: { title: marker('Create a signature') },
    canActivate: [AdminGuard],
  },
];
